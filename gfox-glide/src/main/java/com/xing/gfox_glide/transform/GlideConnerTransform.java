 ...
 */
public class GlideConnerTransform extends BitmapTransformation {
    ...
    public GlideConnerTransform(int radius) {
        this(radius, 0, CornerType.ALL);
    }

    public GlideConnerTransform(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public GlideConnerTransform(int radius, int margin, CornerType cornerType) {
    ...
    public boolean equals(Object o) {
        return o instanceof GlideConnerTransform &&
                ((GlideConnerTransform) o).radius == radius &&
                ((GlideConnerTransform) o).diameter == diameter &&
                ((GlideConnerTransform) o).margin == margin &&
                ((GlideConnerTransform) o).cornerType == cornerType;
    }
