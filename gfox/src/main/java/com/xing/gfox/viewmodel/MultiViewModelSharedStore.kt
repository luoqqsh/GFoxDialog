...
import com.xing.gfox.viewmodel.MultiViewModelDestroyObserver
 ...
 */
internal class MultiViewModelSharedStore private constructor(
    ...
    companion object {
        internal fun <T : ViewModel> create(
            clazz: Class<T>,
            callback: Callback
        ): MultiViewModelSharedStore = MultiViewModelSharedStore(clazz, callback)

    }

    private fun createDestroyObserver(owner: LifecycleOwner) =
        object : MultiViewModelDestroyObserver(owner) {
