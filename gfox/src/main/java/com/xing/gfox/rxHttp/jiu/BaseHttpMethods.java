...
import com.xing.gfox.rxHttp.bean.HttpCallback;
...
//        },filter);
     ...
     */
    public void httpPost(final Activity activity, String url, Map<String, String> postParamMap, final HttpCallback<String> callback) {
     ...
     * callback in UI thread
     */
    public void httpGet(final Activity activity, String url, Map<String, Object> parmamMap, final HttpCallback<String> callback) {
        Request.Builder builder = new Request.Builder();
