...
public class ScrollLayout extends FrameLayout {
    ...
    private ContentNestedScrollView mScrollView;
    ...
    private final ContentNestedScrollView.OnScrollChangedListener mOnScrollChangedListener = new ContentNestedScrollView.OnScrollChangedListener() {
        @Override
    ...
    public void setAssociatedScrollView(ContentNestedScrollView scrollView) {
