...
public class TriangleView extends View {
    ...
    private static final int DEFUALT_COLOR = R.color.white;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mWidth == 0 || widthMode != MeasureSpec.EXACTLY) {
            mWidth = (int) U_screen.dp2px(getContext(), DEFUALT_WIDTH);
        }
        if (mHeight == 0 || heightMode != MeasureSpec.EXACTLY) {
            mHeight = (int) U_screen.dp2px(getContext(), DEFUALT_HEIGHT);
        }
