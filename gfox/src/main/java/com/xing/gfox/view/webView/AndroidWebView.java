...
//        ViseLog.d(result);
        ...
        public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, WebChromeClient.FileChooserParams fileChooserParams) {
            CSystemPickDialog.builder().setOnSingleListener(mediaFileBean -> {
                Uri[] results = new Uri[]{mediaFileBean.getFilePathUri()};
                filePathCallback.onReceiveValue(results);
            }).startPick((FragmentActivity) webView.getContext(), CPickType.images);
            return true;
        }
