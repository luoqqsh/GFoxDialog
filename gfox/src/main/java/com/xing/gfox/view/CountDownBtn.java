...
public class CountDownBtn extends androidx.appcompat.widget.AppCompatTextView {
    public CountDownBtn(@NonNull @NotNull Context context) {
        super(context);
    }

    public CountDownBtn(@NonNull @NotNull Context context, @Nullable @org.jetbrains.annotations.Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CountDownBtn(@NonNull @NotNull Context context, @Nullable @org.jetbrains.annotations.Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * 计时结束监听
     */
    private OnSimpleListener onFinishListener;
        ...
        if (mCountDownTimer == null) {
            mCountDownTimer = new CountDownTimer(mCount, mInterval) {
                ...
                public void onFinish() {
                    ...
                    if (onFinishListener != null) onFinishListener.onListen();
                }
            };
        }
        // 开始倒计时
...
//        setText(TextUtils.isEmpty(mCdFinishText) ? getText().toString() : mCdFinishText);
    ...
    public void setOnFinishListener(OnSimpleListener onFinishListener) {
