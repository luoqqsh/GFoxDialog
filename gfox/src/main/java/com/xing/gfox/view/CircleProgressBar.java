...
/**
 * https://github.com/dinuscxj/CircleProgressBar/blob/master/circleprogressbar/src/main/res/values/attrs.xml
 */
public class CircleProgressBar extends View {
    ...
    private static final class DefaultProgressFormatter implements ProgressFormatter {
        ...
        public CharSequence format(int progress, int max) {
            return String.format(DEFAULT_PATTERN, Math.min((int) ((float) progress / (float) max * 100), max));
        }
    }
