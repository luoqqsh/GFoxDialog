 ...
 * 请在ImmBarEnabled方法中实现你的沉浸式代码，
 * ImmersionProxy已经做了ImmBar.with(mFragment).destroy()了，所以不需要在你的代码中做这个处理了
 * 如果不能继承，请拷贝代码到你的项目中
 *
 * @author geyifeng
 * @date 2017 /5/12
...
public abstract class SimpleImmersionFragment extends Fragment implements SimpleImmersionOwner {
    ...
    /**
     * 是否可以实现沉浸式，当为true的时候才可以执行initImmBar方法
     * Immersion bar enabled boolean.
     *
     * @return the boolean
     */
    @Override
    public boolean ImmBarEnabled() {
        return true;
    }
}
