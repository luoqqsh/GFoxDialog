...
class RequestManagerRetriever implements Handler.Callback {
    ...
    private String mTag = ImmBar.class.getName();
     ...
     */
    public ImmBar get(Activity activity) {
     ...
     * @return the immersion bar
     */
    public ImmBar get(Fragment fragment, boolean isOnly) {
    ...
    public ImmBar get(android.app.Fragment fragment, boolean isOnly) {
        checkNotNull(fragment, "fragment is null");
        checkNotNull(fragment.getActivity(), "fragment.getActivity() is null");
     ...
     * @return the immersion bar
     */
    public ImmBar get(Activity activity, Dialog dialog) {
        checkNotNull(activity, "activity is null");
