...
public final class ImmBar implements ImmersionCallback {
     ...
     */
    private int mFitsStatusBarType = Constants.FLAG_FITS_DEFAULT;
    /**
     * 是否已经调用过init()方法了
     */
     ...
     */
    public static ImmBar with(@NonNull Activity activity) {
     ...
     * @return the immersion bar
     */
    public static ImmBar with(@NonNull Fragment fragment) {
     ...
     * @return the immersion bar
     */
    public static ImmBar with(@NonNull Fragment fragment, boolean isOnly) {
     ...
     * @return the immersion bar
     */
    public static ImmBar with(@NonNull android.app.Fragment fragment) {
        return getRetriever().get(fragment, false);
    }
     ...
     * @return the immersion bar
     */
    public static ImmBar with(@NonNull android.app.Fragment fragment, boolean isOnly) {
        return getRetriever().get(fragment, isOnly);
    }
     ...
     * @return the immersion bar
     */
    public static ImmBar with(@NonNull DialogFragment dialogFragment) {
     ...
     * @return the immersion bar
     */
    public static ImmBar with(@NonNull android.app.DialogFragment dialogFragment) {
        return getRetriever().get(dialogFragment, false);
    }
     ...
     * @return the immersion bar
     */
    public static ImmBar with(@NonNull Activity activity, @NonNull Dialog dialog) {
    ...
    private void setSpecialBarDarkMode() {
        if (OSUtils.isMIUI6Later()) {
            //修改miui状态栏字体颜色
            SpecialBarFontUtils.setMIUIBarDark(mWindow, Constants.IMMERSION_MIUI_STATUS_BAR_DARK, mBarParams.statusBarDarkFont);
            //修改miui导航栏图标为黑色
            if (mBarParams.navigationBarEnable) {
                SpecialBarFontUtils.setMIUIBarDark(mWindow, Constants.IMMERSION_MIUI_NAVIGATION_BAR_DARK, mBarParams.navigationBarDarkIcon);
            }
        }
        // 修改Flyme OS状态栏字体颜色
    ...
    private void setupStatusBarView() {
        View statusBarView = mDecorView.findViewById(Constants.IMMERSION_ID_STATUS_BAR_VIEW);
    ...
    private void setupNavBarView() {
        View navigationBarView = mDecorView.findViewById(Constants.IMMERSION_ID_NAVIGATION_BAR_VIEW);
    ...
    private void adjustDarkModeParams() {
        if (mBarParams.autoStatusBarDarkModeEnable && mBarParams.statusBarColor != Color.TRANSPARENT) {
            boolean statusBarDarkFont = mBarParams.statusBarColor > Constants.IMMERSION_BOUNDARY_COLOR;
        ...
        if (mBarParams.autoNavigationBarDarkModeEnable && mBarParams.navigationBarColor != Color.TRANSPARENT) {
            boolean navigationBarDarkIcon = mBarParams.navigationBarColor > Constants.IMMERSION_BOUNDARY_COLOR;
    ...
    private void fitsWindowsAboveLOLLIPOP() {
        ...
        int top = 0;
        if (mBarParams.fits && mFitsStatusBarType == Constants.FLAG_FITS_SYSTEM_WINDOWS) {
     ...
     * e.g:getWindow().getDecorView().post(() -> ImmBar.hasNotchScreen(this));
     *
     * @param activity the activity
     * @return the boolean
     */
     ...
     * 刘海屏高度
     * Notch height int.
     * e.g: getWindow().getDecorView().post(() -> ImmBar.getNotchHeight(this));
     *
     * @param activity the activity
     * @return the int
     */
     ...
     * @param fragment the fragment
     */
    ImmBar(android.app.Fragment fragment) {
        mIsFragment = true;
        mActivity = fragment.getActivity();
        mFragment = fragment;
        checkInitWithActivity();
     ...
     * @param dialogFragment the dialog fragment
     */
    ImmBar(DialogFragment dialogFragment) {
        mIsDialog = true;
     ...
     * @param dialogFragment the dialog fragment
     */
    ImmBar(android.app.DialogFragment dialogFragment) {
        mIsDialog = true;
        mIsDialogFragment = true;
        mActivity = dialogFragment.getActivity();
     ...
     * @param dialog   the dialog
     */
    ImmBar(Activity activity, Dialog dialog) {
        mIsDialog = true;
        mActivity = activity;
        mDialog = dialog;
        checkInitWithActivity();
     ...
     * @return the immersion bar
     */
    public ImmBar transparentStatusBar() {
     ...
     * @return the immersion bar
     */
    public ImmBar transparentNavigationBar() {
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarColor(@ColorRes int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarColor(String statusBarColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarColorInt(@ColorInt int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarColor(@ColorRes int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarColor(String navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarColorInt(@ColorInt int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar barColor(@ColorRes int barColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar barColor(@ColorRes int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public ImmBar barColor(String barColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar barColor(String barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public ImmBar barColorInt(@ColorInt int barColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar barColorInt(@ColorInt int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarColor = barColor;
        mBarParams.navigationBarColor = barColor;
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarColorTransform(@ColorRes int statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarColorTransform(String statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarColorTransformInt(@ColorInt int statusBarColorTransform) {
        mBarParams.statusBarColorTransform = statusBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarColorTransform(@ColorRes int navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarColorTransform(String navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarColorTransformInt(@ColorInt int navigationBarColorTransform) {
        mBarParams.navigationBarColorTransform = navigationBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public ImmBar barColorTransform(@ColorRes int barColorTransform) {
     ...
     * @return the immersion bar
     */
    public ImmBar barColorTransform(String barColorTransform) {
     ...
     * @return the immersion bar
     */
    public ImmBar barColorTransformInt(@ColorInt int barColorTransform) {
        mBarParams.statusBarColorTransform = barColorTransform;
        mBarParams.navigationBarColorTransform = barColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public ImmBar addViewSupportTransformColor(View view) {
     ...
     * @return the immersion bar
     */
    public ImmBar addViewSupportTransformColor(View view, @ColorRes int viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public ImmBar addViewSupportTransformColor(View view, @ColorRes int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public ImmBar addViewSupportTransformColor(View view, String viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public ImmBar addViewSupportTransformColor(View view, String viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public ImmBar addViewSupportTransformColorInt(View view, @ColorInt int viewColorAfterTransform) {
        if (view == null) {
     ...
     * @return the immersion bar
     */
    public ImmBar addViewSupportTransformColorInt(View view, @ColorInt int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public ImmBar viewAlpha(@FloatRange(from = 0f, to = 1f) float viewAlpha) {
     ...
     * @return the immersion bar
     */
    public ImmBar removeSupportView(View view) {
        if (view == null) {
            throw new IllegalArgumentException("View参数不能为空");
        }
     ...
     * @return the immersion bar
     */
    public ImmBar removeSupportAllView() {
        if (mBarParams.viewMap.size() != 0) {
     ...
     * @return the immersion bar
     */
    public ImmBar fullScreen(boolean isFullScreen) {
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarAlpha(@FloatRange(from = 0f, to = 1f) float statusAlpha) {
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarAlpha(@FloatRange(from = 0f, to = 1f) float navigationAlpha) {
        mBarParams.navigationBarAlpha = navigationAlpha;
     ...
     * @return the immersion bar
     */
    public ImmBar barAlpha(@FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarAlpha = barAlpha;
     ...
     * @return the immersion bar
     */
    public ImmBar autoDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public ImmBar autoDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
     ...
     * @return the immersion bar
     */
    public ImmBar autoStatusBarDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public ImmBar autoStatusBarDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
        mBarParams.autoStatusBarDarkModeEnable = isEnable;
        mBarParams.autoStatusBarDarkModeAlpha = autoDarkModeAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public ImmBar autoNavigationBarDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public ImmBar autoNavigationBarDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
        mBarParams.autoNavigationBarDarkModeEnable = isEnable;
        mBarParams.autoNavigationBarDarkModeAlpha = autoDarkModeAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarDarkFont(boolean isDarkFont) {
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarDarkFont(boolean isDarkFont, @FloatRange(from = 0f, to = 1f) float statusAlpha) {
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarDarkIcon(boolean isDarkIcon) {
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarDarkIcon(boolean isDarkIcon, @FloatRange(from = 0f, to = 1f) float navigationAlpha) {
     ...
     * @return the immersion bar
     */
    public ImmBar flymeOSStatusBarFontColor(@ColorRes int flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar flymeOSStatusBarFontColor(String flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar flymeOSStatusBarFontColorInt(@ColorInt int flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar hideBar(BarHide barHide) {
     ...
     * @return the immersion bar
     */
    public ImmBar applySystemFits(boolean applySystemFits) {
     ...
     * @return the immersion bar
     */
    public ImmBar fitsSystemWindows(boolean fits) {
     ...
     * @return the immersion bar
     */
    public ImmBar fitsSystemWindows(boolean fits, @ColorRes int contentColor) {
     ...
     * @return the immersion bar
     */
    public ImmBar fitsSystemWindowsInt(boolean fits, @ColorInt int contentColor) {
    ...
    /**
     * 是否可以修复状态栏与布局重叠，默认为true，只适合ImmBar#statusBarView，ImmBar#titleBar，ImmBar#titleBarMarginTop
     * Fits layout overlap enable immersion bar.
     *
     * @param fitsLayoutOverlapEnable the fits layout overlap enable
     * @return the immersion bar
     */
    public ImmBar fitsLayoutOverlapEnable(boolean fitsLayoutOverlapEnable) {
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarView(View view) {
        if (view == null) {
            return this;
        }
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarView(@IdRes int viewId) {
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarView(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public ImmBar titleBar(View view) {
        if (view == null) {
            return this;
        }
     ...
     * @return the immersion bar
     */
    public ImmBar titleBar(View view, boolean statusBarColorTransformEnable) {
        if (view == null) {
            return this;
        }
        if (mFitsStatusBarType == Constants.FLAG_FITS_DEFAULT) {
     ...
     * @return the immersion bar
     */
    public ImmBar titleBar(@IdRes int viewId) {
     ...
     * @return the immersion bar
     */
    public ImmBar titleBar(@IdRes int viewId, boolean statusBarColorTransformEnable) {
     ...
     * @return the immersion bar
     */
    public ImmBar titleBar(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public ImmBar titleBar(@IdRes int viewId, View rootView, boolean statusBarColorTransformEnable) {
     ...
     * @return the immersion bar
     */
    public ImmBar titleBarMarginTop(@IdRes int viewId) {
        if (mSupportFragment != null && mSupportFragment.getView() != null) {
     ...
     * @return the immersion bar
     */
    public ImmBar titleBarMarginTop(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public ImmBar titleBarMarginTop(View view) {
        if (view == null) {
            return this;
        }
        if (mFitsStatusBarType == Constants.FLAG_FITS_DEFAULT) {
     ...
     * @return the immersion bar
     */
    public ImmBar supportActionBar(boolean isSupportActionBar) {
     ...
     * @return the immersion bar
     */
    public ImmBar statusBarColorTransformEnable(boolean statusBarColorTransformEnable) {
        mBarParams.statusBarColorEnabled = statusBarColorTransformEnable;
        return this;
    }
     ...
     * @return the bar tag
     */
    public ImmBar addTag(String tag) {
        if (isEmpty(tag)) {
     ...
     * @return the immersion bar
     */
    public ImmBar getTag(String tag) {
        if (isEmpty(tag)) {
            throw new IllegalArgumentException("tag不能为空");
        }
     ...
     * @return the immersion bar
     */
    public ImmBar keyboardEnable(boolean enable) {
     ...
     * @return the immersion bar
     */
    public ImmBar keyboardEnable(boolean enable, int keyboardMode) {
     ...
     * @return the immersion bar
     */
    public ImmBar keyboardMode(int keyboardMode) {
        mBarParams.keyboardMode = keyboardMode;
        return this;
    }
     ...
     */
    public ImmBar setOnKeyboardListener(@Nullable OnKeyboardListener onKeyboardListener) {
     ...
     */
    public ImmBar setOnNavigationBarListener(OnNavigationBarListener onNavigationBarListener) {
     ...
     */
    public ImmBar setOnBarListener(OnBarListener onBarListener) {
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarEnable(boolean navigationBarEnable) {
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarWithKitkatEnable(boolean navigationBarWithKitkatEnable) {
     ...
     * @return the immersion bar
     */
    public ImmBar navigationBarWithEMUI3Enable(boolean navigationBarWithEMUI3Enable) {
        //是否可以修改emui3系列手机导航栏
     ...
     * @return the immersion bar
     */
    public ImmBar barEnable(boolean barEnable) {
