 ...
 */
public class U_thread {

    private static Handler sMainHandler = new Handler(Looper.getMainLooper());
    private static final String TAG = U_thread.class.getName();
    ...
    private static final ThreadFactory THREAD_FACTORY = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "hl_thread #" + mCount.getAndIncrement());
        }
    };
    /**
    ...
    public static void runOnSubThread(Runnable runnable) {
        ...
        if (THREAD_POOL_EXECUTOR.getQueue().size() == 128 || THREAD_POOL_EXECUTOR.isShutdown()) {
            ViseLog.e(TAG, "线程池爆满警告，请查看是否开启了过多的耗时线程");
            return;
        }
