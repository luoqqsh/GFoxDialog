...
public class U_country {
     ...
     */
    public static String getCountryCodeBySim(Context context, String defaultValue) {
        String code = getCountryCodeFromMap().get(getCountryBySim(context));
        if (code == null) {
            return defaultValue;
        }
        return code;
