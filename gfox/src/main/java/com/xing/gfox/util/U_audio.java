...
public class U_audio {
    ...
    private static U_audio mInstance;

    private U_audio(Context context){
        mAudioManager = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
    }

    public synchronized static U_audio getInstance(Context context){
        if(mInstance == null){
            mInstance = new U_audio(context);
        }
        return mInstance;
    }
