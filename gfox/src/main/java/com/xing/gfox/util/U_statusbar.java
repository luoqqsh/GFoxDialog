...
public class U_statusbar {
     ...
     * @param colorId  颜色值
     */
    public static void setStatusBarColorAndText(Activity activity, int colorId) {
        setStatusBarColor(activity, colorId);
        setStatusBarDarkTheme(activity, com.xing.gfox.util.U_color.isLightColor(colorId));
    }
    ...
    public static void setNavigationBarColor(Activity activity, int color) {
        ...
        } else if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT && color == Color.TRANSPARENT) {
    ...
    public static boolean setStatusBarDarkTheme(Activity activity, boolean dark) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            } else if (com.xing.gfox.util.U_rom.isMiui()) {
                setStatusBarFontIconDark(activity, TYPE_MIUI, dark);
            } else if (com.xing.gfox.util.U_rom.isFlyme()) {
