package com.xing.gfox.log.common;


import com.xing.gfox.log.config.LogDefaultConfig;
import com.xing.gfox.log.parser.BundleParse;
import com.xing.gfox.log.parser.CollectionParse;
import com.xing.gfox.log.parser.IntentParse;
import com.xing.gfox.log.parser.MapParse;
import com.xing.gfox.log.parser.Parser;
import com.xing.gfox.log.parser.ReferenceParse;
import com.xing.gfox.log.parser.ThrowableParse;
...
public class LogConstant {
    ...
    // 默认支持解析库
    public static final Class[] DEFAULT_PARSE_CLASS = new Class[]{
