...
import com.xing.gfox.log.config.LogConfig;
import com.xing.gfox.log.config.LogDefaultConfig;
import com.xing.gfox.log.inner.SoulsTree;
import com.xing.gfox.log.inner.Tree;
...
public class ViseLog {
    ...
    public static void showInfo(Object object) {
        TREE_OF_SOULS.showInfo(object);
    }

    public static void showInfo(String tag, Object object) {
        setTag(tag);
        TREE_OF_SOULS.showInfo(object);
    }

    public static void showLog(Object object) {
        TREE_OF_SOULS.showLog(object);
    }

    public static void showLog(String tag, Object object) {
        setTag(tag);
        TREE_OF_SOULS.showLog(object);
    }
