...
public class SEventBus {
    private static SEventBus instance = new SEventBus();
    ...
    private static SEventBus getDefault() {
        return instance;
    }
    ...
    private List<SubscribleMethod> getSubscribleMethods(Object subscriber) {
        ...
        while (aClass != null) {
            ...
            for (Method method : declaredMethods) {
                ...
                //符合
                SThreadMode sThreadMode = annotation.threadMode();
                SubscribleMethod subscribleMethod = new SubscribleMethod(method, sThreadMode, parameterTypes[0]);
