...
public class LogActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void bindViews() {
        mPrint_normal_message = findViewById(R.id.print_normal_message);
        mPrint_normal_object = findViewById(R.id.print_normal_object);
        mPrint_bundle_object = findViewById(R.id.print_bundle_object);
        mPrint_collection_object = findViewById(R.id.print_collection_object);
        mPrint_intent_object = findViewById(R.id.print_intent_object);
        mPrint_map_object = findViewById(R.id.print_map_object);
        mPrint_reference_object = findViewById(R.id.print_reference_object);
        mPrint_throwable_object = findViewById(R.id.print_throwable_object);
        mPrint_json_message = findViewById(R.id.print_json_message);
        mPrint_xml_message = findViewById(R.id.print_xml_message);
    }
