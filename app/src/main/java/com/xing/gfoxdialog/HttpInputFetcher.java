...
public class HttpInputFetcher implements DataFetcher<InputStream> {
  ...
  public HttpInputFetcher(GlideUrl glideUrl, int timeout) {
    this(glideUrl, timeout, DEFAULT_CONNECTION_FACTORY);
  }

  @VisibleForTesting
  HttpInputFetcher(GlideUrl glideUrl, int timeout, HttpUrlConnectionFactory connectionFactory) {
